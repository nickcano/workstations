...
QPixmap QPixmapIcon::fromHICON(HICON icon)
{
	return convertHIconToPixmap(icon);
}

QImage QPixmapIcon::qt_fromWinHBITMAP(HDC hdc, HBITMAP bitmap, int w, int h)
{
    BITMAPINFO bmi;
...
QPixmap QPixmapIcon::convertHIconToPixmap(HICON icon)
{
